 ...
 */
package questao2Lista7.view;

import javax.swing.JOptionPane;
import questao2Lista7.model.Bairro;
import questao2Lista7.model.Finalidade;
import questao2Lista7.model.Imovel;
...
public class AppUI extends javax.swing.JFrame {
    ...
    private void jButtonCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCalcularActionPerformed
        try {
            ...
            exibirMensagemErro("Algum número foi informado incorretamente");
        } catch (IllegalArgumentException ex) {
            exibirMensagemErro(ex.getMessage());
        } catch (Exception ex) {
            exibirMensagemErro("Erro critico");
        }
